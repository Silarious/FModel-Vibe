...
public class RightClickMenuCommand : ViewModelCommand<ApplicationViewModel>
{
    ...
    /// <summary>
    /// Export a selected folder. Uses one tree-wide parallel pass so sibling folders
    /// (typical model layout: many characters with 1 mesh each) are not serialized
    /// into PeakConcurrentWorkers=1 batches.
    /// </summary>
